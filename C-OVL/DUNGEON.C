...
void F_DUNGEON_0e2e(undefined2 param_1)
{
    ...
    do
    {
        ...
        {
            // 0f93
            if ((local_c == 0) || (D_5893_map_id < 0x21))
            {
                // 0ff2
                if ((D_bb17 & 2) == 0)
                {
        ...
        if (-1 < local_8)
        {
            local_c = F_DUNGEON_06c4_process_command(local_8);
        }
        // 0f47
        ...
        if (local_c != 0)
        {
            FUN_0000_0c76((u8)local_2, local_6);
        }
        // 0f87
        if (D_5893_map_id < 0x21)
        {
...
void F_DUNGEON_0e2e_FMT(undefined2 param_1)
{
    register int si, di;
    int local_e;
    int local_c; // -> si
