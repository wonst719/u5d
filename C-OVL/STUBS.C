...
void FUN_1000_1850_print_string(char *a) { puts("FUN_1000_1850_print_string"); }
...
// 2000
int  FUN_1000_2032_to_upper(unsigned int x) { puts("FUN_1000_2032_to_upper"); }
     ...
     FUN_1000_266c_get_ch() { puts("FUN_1000_266c_get_ch"); }

     FUN_1000_2900() { puts("FUN_1000_2900"); }

int  FUN_1000_2d7a(/*?*/) { puts(""); }

// 4000
     FUN_1000_43ae(int a, int b, int c, int d) { puts("FUN_1000_43ae"); }
     FUN_1000_4d76(void* a, byte b) { puts("FUN_1000_4d76"); }
void FUN_1000_4daa() { puts("FUN_1000_4daa"); }
     FUN_1000_4dea(int a) { puts("FUN_1000_4dea"); }
     FUN_1000_4e20() { puts("FUN_1000_4e20"); }
void FUN_1000_4e50(char *a) { puts("FUN_1000_4e50"); }
     FUN_1000_4efc() { puts("FUN_1000_4efc"); }

     FUN_1000_4f3c() { puts("FUN_1000_4f3c"); }

// 6000
     FUN_1000_6e60(int param_2, int param_1) { puts("FUN_1000_6e60"); }

// thunks
     FUN_0000_8bca() { puts("FUN_0000_8bca"); }
