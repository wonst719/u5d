...
ULTIMA_251e_switch_disks(int x) { debug("ULTIMA_251e_switch_disks(%d)", x); }
...
ULTIMA_25d8_write_file_to_disk(char* file_name, void* addr, u16 size)
{
