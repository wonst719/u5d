...
#define WRITE_16(TARGET) /*debug("%s: %d", #TARGET, (int)ftell(stream)); */ FILE_WriteU16LE(stream, TARGET)
#define WRITE_8(TARGET) /*debug("%s: %d", #TARGET, (int)ftell(stream)); */ FILE_WriteU8(stream, TARGET)
