        ...
        *ULTIMA_4402_GetTileAddr(param_2, param_3) != 0xff)
    {
        ...
        for (local_8 = 0; local_8 < 0x20; local_8++)
        {
            ...
            else if (D_ba14[local_8].x == param_2 && D_ba14[local_8].y == param_3) // a398
            {
                ...
                if ((local_6 & (COMBAT_FLAGS_DEAD | COMBAT_FLAGS_4)) == 0)
                {
                    if (local_6 == 0)
                    {
                        return 0;
...
static int COMBAT_014e(int param_1, int param_2, int param_3)
{
    ...
    if (local_a != 0x1a && ULTIMA_2092_RandomRange(0, 0xff) >= 0x80 || (D_153c_enemyFlags[local_a] & ENEMY_FLAG_MAGIC) != 0 && (D_587a == 'N' ||
        D_587a == 0x1c))
    {
        return 0;
    }
...
static int COMBAT_0226(int param_1)
{
    ...
    else
    {
        ...
        if ((D_ba14[local_4].flags & COMBAT_FLAGS_PLAYER) != 0 &&
            ...
            (D_153c_enemyFlags[local_a] & ENEMY_FLAG_MAGIC) != 0)
        {
        ...
        if (COMSUBS_04d4(param_1, local_4) <= D_159c[local_a])
        {
            ...
            if (COMSUBS_04d4(param_1, local_4) == 1)
            {
                ...
                if ((D_153c_enemyFlags[local_a] & ENEMY_FLAG_STEAL) != 0 && ULTIMA_2092_RandomRange(0, 3) != 0 && D_57a8 != 0)
                {
...
static void COMBAT_03f4(void)
{
        ...
        (local_4->flags & COMBAT_FLAGS_4) == 0)
    {
        ...
        else
        {
            ...
            {
                if ((local_4->flags & COMBAT_FLAGS_PLAYER) == 0 && ULTIMA_2092_RandomRange(0, 3) == 3)
                {
                    local_4->hp++;
                }
...
static void COMBAT_063e_ProcessCommand(void)
{
    ...
    if (D_587b != 0xff && ((D_ba14[D_589e].flags & COMBAT_FLAGS_PLAYER) == 0 || D_587b != local_a))
    {
        SJOG_2012();
    }
    else
...
int COMBAT_0b94_MainLoop(void)
{
    ...
    do
    {
        ...
        do
        {
            ...
            if (((byte)local_6 & (COMBAT_FLAGS_PLAYER | COMBAT_FLAGS_MONSTER)) != 0 && ((byte)local_6 & COMBAT_FLAGS_DEAD) == 0)
            {
                // ae86
                if (((byte)local_6 & COMBAT_FLAGS_PLAYER) != 0 && D_55a8_party[local_8->entityIdx].status == STATUS_DEAD) // monster / non-dead player
                {
                    local_8->flags |= COMBAT_FLAGS_DEAD;
                    ULTIMA_3564(D_589e);
...
static int COMBAT_0d30(int param_1)
{
    ...
    for (local_14 = 0x1f; local_14 > -1; local_14--)
    {
        ...
        if (local_14 != param_1 && local_c->flags != 0 && (local_c->flags & COMBAT_FLAGS_DEAD) == 0)
        {
    ...
    if (local_16 == -1)
    {
        ...
        {
            if ((D_ba14[local_14].flags & COMBAT_FLAGS_MONSTER) != 0)
            {
                D_ba14[local_14].hp = 1;
                D_ba14[local_14].flags |= COMBAT_FLAGS_2;
            }
        }
    ...
    if ((local_6->flags & COMBAT_FLAGS_2) != 0)
    {
        D_5876 *= -1;
        D_5878 *= -1;
    }
...
static int COMBAT_0ee4(int param_1)
{
    ...
    {
        // 0f17
        if ((local_4->flags & COMBAT_FLAGS_PLAYER) == 0 && (D_153c_enemyFlags[local_4->entityIdx] & ENEMY_FLAG_TELEPORT) != 0 && D_587a != 0x4e && D_587a != 0x1c &&
...
int COMBAT_13e2(int param_1, int param_2)
{
    ...
    if ((local_4->flags & COMBAT_FLAGS_MONSTER) != 0)
    {
        if (param_2 == 0)
        {
            if ((D_153c_enemyFlags[local_4->entityIdx] & ENEMY_FLAG_80) != 0)
            {
                // 1411
...
int COMBAT_1574(int param_1, int param_2)
{
    ...
    if ((local_a->flags & COMBAT_FLAGS_PLAYER) != 0)
    {
    ...
    {
        if ((((byte)D_153c_enemyFlags[local_a->entityIdx]) & ENEMY_FLAG_UNDEAD) != 0 && D_5890 == 0)
        {
            param_2 /= 2;
        }

        if ((((byte)D_153c_enemyFlags[local_a->entityIdx]) & ENEMY_FLAG_NO_DAMAGE) != 0)
        {
            param_2 = 0;
        }
        ...
        if (local_a->hp == 0 || param_2 == 99)
        {
            ...
            if ((D_153c_enemyFlags[local_a->entityIdx] & (ENEMY_FLAG_VANISH | ENEMY_FLAG_NO_CORPSE)) == 0)
            {
            ...
            else if ((D_153c_enemyFlags[local_a->entityIdx] & ENEMY_FLAG_VANISH) != 0)
            {
        ...
        else if ((D_153c_enemyFlags[local_a->entityIdx] & ENEMY_FLAG_DIVIDE) != 0)
        {
...
void COMBAT_18ba(int param_1, int param_2)
{
    ...
    if ((D_ba14[param_1].flags & COMBAT_FLAGS_PLAYER) != 0 && D_55a8_party[D_ba14[param_1].entityIdx].status == STATUS_GOOD)
    {
    ...
    else
    {
        ...
        if (param_2 > -1 && (D_ba14[param_2].flags & COMBAT_FLAGS_PLAYER) != 0)
        {
...
void COMBAT_194a(int param_1, int param_2)
{
    ...
    local_6 = 0;
    if ((D_ba14[param_2].flags & COMBAT_FLAGS_PLAYER) == 0)
    {
        local_6 = 1;
    }

    // 1969
    if (local_6 && (D_153c_enemyFlags[D_ba14[param_2].entityIdx] & (ENEMY_FLAG_POISON_200 | ENEMY_FLAG_POISON_4)) != 0 && ULTIMA_2092_RandomRange(0, 3) != 0)
    {
    ...
    else
    {
        ...
        if (D_5890 == 0 || D_589d != 51)
        {
            ...
            if (local_8 < 0 && (D_ba14[param_1].flags & COMBAT_FLAGS_PLAYER) != 0)
            {
                D_58a2 = 0x20;
                return; // -> 1a54
            }
