#ifndef _ULTIMA_6000_H
#define _ULTIMA_6000_H
...
int ULTIMA_6506(int a, int b, int c, int d, int e);
void ULTIMA_6800(int a);
void ULTIMA_6880(int param_1);
void ULTIMA_68ae(int a);
void ULTIMA_6936(void);
int ULTIMA_6d82(int a, int b);
int ULTIMA_6da8(int a);
